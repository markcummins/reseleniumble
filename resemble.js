...
(function (root, factory) {
	...
	var resemble = function( fileData ){
		...
		function analyseImages(img1, img2, width, height, one, two){
		...
		function compare(one, two){
			...
			function onceWeHaveBoth(){
				...
				if(images.length === 2){
					...
					analyseImages( normalise(images[0],width, height), normalise(images[1],width, height), width, height, one, two);
